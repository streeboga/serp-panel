...
Чего аудит намеренно не делает: вес изображений и битые ссылки (запрос на каждый файл),
валидация W3C и PageSpeed (внешние API), CLS и контраст (нужен настоящий браузер).
