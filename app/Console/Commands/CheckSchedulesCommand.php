...
class CheckSchedulesCommand extends Command
{
    ...
    public function handle(EngineScraperRouter $router): int
    {
        ...
        foreach ($schedules as $schedule) {
            ...
            foreach ($keywords as $keyword) {
                ScrapeJob::create([
                    ...
                    'scraper_id' => $router->scraperIdFor($schedule->scraper->organization_id, $schedule->scraper_id, $keyword->engine->value),
