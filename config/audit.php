...
return [
    ...
    /*
     * Поведенческие данные из Метрики клиента. Токен берётся у организации
     * (тот же OAuth, что и у Вордстата), счётчик задаётся на проекте.
     */
    'metrika' => [
        'timeout' => (int) env('AUDIT_METRIKA_TIMEOUT', 30),
        'days' => (int) env('AUDIT_METRIKA_DAYS', 180),
    ],
